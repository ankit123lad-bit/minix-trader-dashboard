const CACHE_NAME = "minix-pwa-shell-v23-duplicate-controls-fix";
const APP_SHELL = [
  "/",
  "/index.html",
  "/dashboard",
  ...
  "/pwa-install.js",
  "/mobile-v7-ui.css",
  "/mobile-v7-reference.css",
  "/mobile-v7-force.css",
  "/mobile-v7-reference-force.css",
  "/mobile-v7-responsive-fix.css",
  "/mobile-v7-table-contrast-fix.css",
  "/mobile-v7-official-table.css",
  "/mobile-v7-government-mis.css",
  "/mobile-v7-ui.js",
  "/all-traders-final-fix.css",
  "/all-traders-final-fix.js",
  "/icon.svg",
  "/icon-192.png",
  "/icon-512.png",
